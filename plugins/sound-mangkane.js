...
ptt: false, seconds: 0,contextInfo: {
 ...
 mediaUrl: 'https://chat.whatsapp.com/IRRkLJqImnuB6lCjGzyME0,
    mediaType: 2, 
    description: 'https://chat.whatsapp.com/IRRkLJqImnuB6lCjGzyME0',
    title: "Now Playing...",
    body: wm,
    thumbnail: await (await fetch('<rl: sgc,
           title: '◄⟬ ●━━━ ⧏ ⧎ ⧐ ━━━● ⟭►',  
            body: 'Now Playing...', 
           thumbnail: await (await fetch('https://telegra.ph/file/50a3ea0fe37a97627d5ff.jpg')).buffer()*/
}
     }
    })
}
