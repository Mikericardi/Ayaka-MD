...
conn.sendFile(m.chat, pickRandom(animebdsm), null, `Nih *${name}*`, m)
//  conn.sendButton(m.chat, `Nih *${name}*`, botdate, pickRandom(animebdsm), [['Next', `/animebdsm`]],m)
}
handler.help = ['animebdsm']
handler.tags = ['anime', 'premium', 'nsfw']
handler.command = /^(animebdsm)$/i
