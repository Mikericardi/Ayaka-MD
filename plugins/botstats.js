...
let handler = async (m, { conn, generateWAMessageFromContent, }) => {
    ...
    const fgclink = {
           ...
           "message": {
               "groupInviteMessage": {
                   "groupJid": "6281226416919-1625305606@g.us",
                   "inviteCode": "null",
                   "groupName": "Halo", 
                   "caption": wm, 
...
await conn.sendButton(m.chat, '▷ʙᴏᴛ sᴛᴀᴛᴜs◁', sts, pu, [['Owner', '.owner']], m, { contextInfo: { externalAdReply: {
	showAdAttribution: true,
	mediaUrl: 'https//wa.me/62830291942?text=Hᴀʟᴏ+ɢᴀɴᴛᴇɴɢᴋᴜ',
	mediaType: 2,
	description: 'https//wa.me/6281226416919?text=Hᴀʟᴏ+ɢᴀɴᴛᴇɴɢᴋᴜ',
